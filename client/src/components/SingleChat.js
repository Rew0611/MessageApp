...
import bcg2 from '../assets/wireless.svg';
...
function SingleChat() {
  ...
  var clr = onlineStatus?'green':'grey'
  
  const ChangeColor = () => {
    clr = onlineStatus?'green':'grey';
  };
      ...
      {selectedChat ? (
        <>
          ...
          >
            ...
            <Box py='2' pb='4' px='4' bg='transparent'>
        ...
        >
          ...
          >
            ...
            <Text textAlign='center' fontWeight='300' color='gray.400'>
              MessageApp is centralized and doesn't need phone to be connected.
