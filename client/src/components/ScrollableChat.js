        ...
        return (
          ...
          >
            ...
            <HStack
              ...
              bg={`${
                message.sender._id === currentUser.id ? "#0099ff" : "white"
              }`}
              color={`${
                message.sender._id === currentUser.id ? "white" : "black"
              }`}
              borderRadius="md"
              shadow="base"
            >
              ...
              <Text
                ...
                fontSize="0.75rem"
                color={`${
                  message.sender._id === currentUser.id ? "#f5f5f5" : "gray.500"
                }`}
                opacity={`${
                  message.sender._id === currentUser.id ? "0.8" : "1"
                }`}
              >
